/**
 * @module order_checkbook
 * @description This module allows the customer to order a checkbook.
 * @author Rifah
 */
...
/**
 * Middleware for parsing request bodies using Express's urlencoded method.
 *
 * @function
...
/**
 * Adds an event listener to the "orderForm" element, preventing the default form submission
...
document.getElementById("orderForm").addEventListener("submit", function (event) {
    ...
    /**
     * Get the form data from the "orderForm" element.
     * @type {FormData}
     */
     ...
     *
     * @param {string} '/submitForm1' - The URL to send the POST request to.
     * @param {Object} {
     *     method: 'POST',
     *     body: formData
     * } - Fetch options, including method and body.
     */
    fetch('/submitForm1', {
        method: 'POST',
        body: formData,
